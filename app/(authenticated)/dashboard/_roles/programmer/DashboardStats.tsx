  ...
  return (
    <div className="grid gap-5 grid-cols-2 lg:grid-cols-4">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900">{summary.pending}</p>
          </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-sm font-medium text-red-600">Revision</p>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900">{summary.revision}</p>
          </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900">{summary.approved}</p>
          </div>
